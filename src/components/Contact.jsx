...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "7dd6b199-487a-4edf-b5be-e5bd3e6e68c7");
       ...
       viewport={{once:true}}
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
            ...
            <div className='my-6 text-left'>
                Message
                <textarea className='w-full border border-gray-300 rounded py-3 px-4 mt-2' name='Massage' placeholder='Message' required></textarea>
            </div>
